...
[TestClass]
public sealed class LowestLifeEnemyTargetChooserTests
{
    [TestMethod]
    public void ChooseTargetId_Should_Return_Lowest_Life_Target()
    {
        var chooser = new LowestLifeEnemyTargetChooser();
